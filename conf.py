...
project = 'Blow Your Mind With Haskell'

# Change this to the tagline of your blog
tagline = 'Musings of a Haskell Learner'

# Change this to the description of your blog
description = 'A Haskell tutorial'
...
disqus_shortname = 'blowyourmindwithhaskell'
...
extensions = ['tinkerer.ext.blog', 'tinkerer.ext.disqus', 'sphinx.ext.pngmath']
